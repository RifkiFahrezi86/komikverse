...
const SLOT_LABELS: Record<string, { label: string; desc: string }> = {
  "home-top": { label: "Home - Atas", desc: "Banner di bagian atas halaman utama" },
  "home-mid": { label: "Home - Tengah", desc: "Antara section update dan populer" },
  "detail-sidebar": { label: "Detail - Sidebar", desc: "Sidebar di halaman detail komik" },
  "detail-before-chapters": { label: "Detail - Sebelum Chapter", desc: "Sebelum daftar chapter" },
  "reader-top": { label: "Reader - Atas", desc: "Di atas gambar chapter" },
  "reader-bottom": { label: "Reader - Bawah", desc: "Di bawah gambar chapter" },
  "reader-between": { label: "Reader - Antara Gambar", desc: "Disisipkan di antara gambar chapter (setiap 10 gambar)" },
};
  ...
  return (
    <div>
      <h2 className="font-display text-lg font-bold text-white/85 flex items-center gap-2 mb-2">
        <Megaphone size={20} className="text-[#f97316]" /> Kelola Iklan / Adsense
      </h2>
      <p className="text-xs text-[#5c5c6e] font-body mb-5">
        Tempel kode iklan (Google Adsense, dll) ke slot yang tersedia. Iklan dapat diaktifkan/nonaktifkan per posisi.
      </p>
          ...
          return (
            <div key={ad.id} className="bg-[#12121a] rounded-xl border border-white/[0.04] p-4">
                ...
                >
                  {ad.is_active ? (
                    ...
                    <>
                      ...
                      <span className="text-[#5c5c6e]">Nonaktif</span>
                    </>
                  )}
                </button>
              </div>
              ...
              <textarea
                ...
                placeholder="Tempel kode iklan di sini... (HTML/script Adsense)"
                rows={4}
