...
const SLOT_META: Record<string, { desc: string; adType: string; hint: string; size: string }> = {
  ...
  "home-bottom-1": { desc: "Banner bawah homepage (setelah section populer)", adType: "Banner 320×50", hint: "Gunakan kode: Banner 320×50 (atOptions iframe)", size: "320×50" },
  "home-bottom-2": { desc: "Banner paling bawah homepage", adType: "Banner 320×50", hint: "Gunakan kode: Banner 320×50 (atOptions iframe)", size: "320×50" },
  "browse-banner": { desc: "Banner di halaman Genre & Pencarian", adType: "Banner 320×50", hint: "Gunakan kode: Banner 320×50 (atOptions iframe)", size: "320×50" },
};
